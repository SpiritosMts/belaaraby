...
class AddItemView extends StatelessWidget {
  AddItemCtr gc = Get.find<AddItemCtr>();
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddItemCtr>(
        initState: (_)  {
          print('## open AddItemView View');

          //print('## ${gc.currentCurrency}');
        },
        dispose: (_) {
          print('## close AddItemView View');
        },
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(currencySymbol(gc.currentCurrency),
                                      style: GoogleFonts.almarai(
                                        textStyle:  TextStyle(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            style: ylwStyle,
                            onPressed: () async {
                              await gc.addItemToStore(context, pc.st.id!);
                            },
                            child: Text(
                              "Add".tr,
